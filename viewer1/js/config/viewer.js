define([
    ...
    GoogleMapsLoader.KEY = 'AIzaSyBPFDwbMpyxDfgHgRruTpcB4j9KT67dNIk';
    ...
    var maplods = [
        ...
        {"level" : 21, "resolution" : 0.074645535, "scale" : 282.124294},
        {"level" : 22, "resolution" : 0.0373227677059521225, "scale" : 141.0621470000000125}
    ];
    ...
    return {
        ...
        */
        ...
        operationalLayers: [{
            type: 'dynamic',
            url: 'https://geospas.doe.gov.my/jarvis02/rest/services/DataAsas/Sempadan_Pentadbiran_Semenanjung/MapServer',
            ...
            type: 'feature',
            url: 'https://geospas.doe.gov.my/jarvis02/rest/services/JHR/PAT_Johor2017/FeatureServer/0',
        ...
        widgets: {
            ...
            directions: {
                ...
                options: {
                    ...
                    options: {
                        routeTaskUrl: 'https://nav.1malaysiamap.gov.my/arcgis/rest/services/Routing/Routing/NAServer/Route',
                        routeParams: {
